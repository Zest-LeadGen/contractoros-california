...
| R-H1-17 | Current project-control records become stale immediately after initial delivery and misdirect the next actor to recreate completed work. | Active Issue #76 ledger, validation, report, decision, risk, and traceability records now distinguish historical initial delivery, R1 findings, bounded correction, and remaining gates. | Correction implemented; fresh independent exact-SHA verification pending. |
| R-H1-18 | PR-body exact-head and commit-count evidence becomes stale after the correction commit. | Retrieve the live body after push, validate one bounded replacement against the new head and actual counts, recheck immediately before mutation, and inspect the edited-event workflow. | Correction implemented locally; controlled body replacement and fresh independent exact-SHA verification pending. |
