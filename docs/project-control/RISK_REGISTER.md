...
| `R-H0-DISP-001` | `RT-H0-DISP-001` | Open-work terminal dispositions are incomplete; point-in-time counts can drift. | Preserve the 1 PR / 27 issue / 28 total observation, keep Issue #51 open as blocked backlog, and require pagination-complete pre-closeout refresh. | Active / blocking H0 closeout. | ContractorOS owner / H0 evidence gate | `SRC-H0-EVIDENCE-001`, `SRC-H0-EVIDENCE-002` | Every live open item receives a valid terminal disposition and the refreshed total reconciles with no unclassified item. | 2026-07-17 |
| `R-H0-BRANCH-001` | `RT-H0-BRANCH-001` | Thirty-seven observed non-default branches lack verified terminal preservation, deletion, or deferral dispositions. | No branch deletion; preserve point-in-time evidence; require complete live branch refresh and owner-authorized dispositions. | Active / blocking H0 closeout. | ContractorOS owner / H0 evidence gate | `SRC-H0-EVIDENCE-001`, `SRC-H0-EVIDENCE-002` | Every refreshed non-default branch receives an exact terminal disposition with preservation evidence and authority. | 2026-07-17 |
| `R-H8-AI-001` | `RT-H0-APP-001` | ChatGPT Codex Connector has observed broad write access across current and future Zest-LeadGen repositories. | No connector change during H0; H1-H4 prerequisites; H7A coordination; transfer and trigger-based revalidation. | Accepted for H8 roadmap / no implementation authority. | ContractorOS owner / H8 gate / security gate | `SRC-H0-AI-001` through `SRC-H0-AI-005`, `OD-H0-AI-001` | Selected-repository least privilege and separate developer/reviewer principals are implemented, independently verified, merged, main-verified, and assured at H9. | 2026-07-17 |
...
| `R-H8-AI-002` | `RT-H0-APP-002` | Remaining Claude, Copilot Chat App, Copilot SWE agent, and GitHub Desktop permission details are not proven. | No AI permission change or H8 implementation before revalidation; expiry 2026-08-17. | Validly deferred / partially verified. | ContractorOS owner / H8 gate | `SRC-H0-AI-003`, `SRC-H0-AI-004`, `SRC-H0-AI-005` | Live permission evidence is captured and reviewed before H8 implementation or permission change, or the finding blocks H8. | 2026-07-17 |
