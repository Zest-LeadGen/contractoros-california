# H1-B3 Push-Context FP Remediation R2 Gate Report
...
- `.github/workflows/control-gates.yml` (the Claim-language step gains the event condition)
- `docs/project-control/DEVELOPMENT_LEDGER.md`
- `docs/project-control/DECISION_LOG.md`
- `docs/project-control/RISK_REGISTER.md`
- `docs/project-control/phase_h1_b3_fp_remediation_r2_report.md` (new)
...
Adds the Sequential Unmasking record (R2 cause, class completion, audit evidence).
